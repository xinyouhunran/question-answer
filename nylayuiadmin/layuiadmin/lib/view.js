...
layui.define(['laytpl', 'layer'], function(exports){
  ...
  /*view.exit = function(callback){
    ...
    //跳转到登入页
    var localtionUrl = window.location + '';
    var lastIndex = localtionUrl.indexOf('/views/');
    var localtionUrlSub = localtionUrl.substring(0, lastIndex);
    top.location.href = localtionUrlSub + "/views/user/login.html";
